...
The :meth:`~Batoms.draw_cavity` function is to draw cavity in porous materials. We find the cavity with a grid based algrothm. Here we search cavity with radius larger than 9.0 in the MOF-5 crystal.
